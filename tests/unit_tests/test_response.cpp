...
void TestResponse::getValue_data()
{
    ...
    QVariant mb1; mb1.setValue(QVariantList{"1", "2", "foobar"});
    QTest::newRow("Multi Bulk")	<< "*3\r\n:1\r\n:2\r\n$6\r\nfoobar\r\n"	<< mb1;

    QVariant mb2; mb2.setValue(QVariantList{"app_id", "0", "keyword", "", "url", "nourl"});
    QTest::newRow("Multi Bulk with empty item")
        << "*6\r\n$6\r\napp_id\r\n$1\r\n0\r\n$7\r\nkeyword\r\n$0\r\n\r\n$3\r\nurl\r\n$5\r\nnourl\r\n"
        << mb2;

    QVariant mb3; mb3.setValue(QVariantList{"app_id", "0", "keyword", "", "url", "n\r\nrl"});
    QTest::newRow("Multi Bulk with \\r\\n in item")
        << "*6\r\n$6\r\napp_id\r\n$1\r\n0\r\n$7\r\nkeyword\r\n$0\r\n\r\n$3\r\nurl\r\n$5\r\nn\r\nrl\r\n"
        << mb3;

    QVariant mb4; mb4.setValue(QVariantList{"app_id", "0", "keyword", QString("快樂").toUtf8()});
    ...
    QTest::newRow("Array of arrays")
        << "*2\r\n"
           ...
           "+Foo\r\n"
           "+Bar\r\n"
        << QVariant(QVariantList{QVariantList{"1", "2", "3"}, QVariantList{"Foo", "Bar"}});
